  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
      ...
      <form method="post">
        ...
        <input required type="number" class="form-control" min="0" max="72" id="hours" name="hours" style="width:93px">
...
Nombre de jugador - Team Rival - Color - tiempo restante     
  ...
  */
  ...
  $team_matches = get_team_matches($_POST['team']) ;


  foreach($team_matches as $match){
    
    $match_players = get_match_players($id_match);

    foreach($match_players as $player){
      $games = get_games_with_moveby($player) // player games (for this team) where he has to move in less than $ hours
    }
